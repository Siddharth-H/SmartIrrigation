 ...
 * @author User
 */
public class Update_Userdata extends javax.swing.JFrame {

    /**
     * Creates new form Update_Userdata
     */
    public Update_Userdata() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Name ", "Email ", "Phone Number", "Address" }));

        jLabel6.setBackground(new java.awt.Color(0, 0, 0));
        jLabel6.setFont(new java.awt.Font("Segoe UI Symbol", 1, 18)); // NOI18N
        jLabel6.setText("Upadate");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Update_Userdata.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Update_Userdata().setVisible(true);
            }
        });
    }
